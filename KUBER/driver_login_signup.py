...
from DriverHomePage import DriverHomePagee
...
class DRIVER_LS:
    ...
    def __init__(self):
        ...
        canvas.pack(pady=(20,0),padx=(90,0))     
        img= (Image.open("./images/big_driver.png"))
        resized_image= img.resize((180,180), Image.ANTIALIAS)
        new_user_image= ImageTk.PhotoImage(resized_image)
        canvas.create_image(20,20, anchor=NW, image=new_user_image)
    ...
    def home(self):
        #LOGIN
        LOGIN_Button = Button(self.gui, text ="LOGIN",justify=CENTER,font=("Ubuntu",18,BOLD),bg="#000",fg="#ffc000",relief=RAISED,command=self.gui_delete_login)
        LOGIN_Button.pack(pady= 8)
        LOGIN_Button.place(x=200,y=250)
        
        #SIGNUP
        SIGNUP_Button = Button(self.gui, text ="SIGNUP",justify=CENTER,font=("Ubuntu",18,BOLD),bg="#000",fg="#ffc000",relief=RAISED,command=self.gui_delete_signup)
        SIGNUP_Button.pack(pady= 8)
        SIGNUP_Button.place(x=193,y=300)
    ...
    def Login_gui(self):
        ...
        self.img= (Image.open("./images/big_driver.png"))
    ...
    def Driver_Login(self):
        ...
        self.text = Text(self.login_gui,font=("Ubuntu",16),height = 1.2, width = 30,pady=3,padx=5)
        self.text.pack()
        self.text.place(x=65,y=280)
        ...
        self.submit_Button.place(x=200,y=410)
    ...
    def Login_Check(self):
        ...
        try:
            ...
            q = "SELECT password,Name,Mob,vehNo FROM Driver where gmail = %s;"
            val = (e_mail,)
            cur.execute(q,val)
            ans = cur.fetchone()
    ...
    def Signup_gui(self):    
        ...
        self.signup_gui.geometry("500x700")
    ...
    def Driver_SignUp(self):
        ...
        # Vehicle No
        self.veh = StringVar()
        self.veh_label = Label(self.signup_gui, textvariable = self.veh,font=("Ubuntu",16,BOLD))
        self.veh.set("Vehicle No :")
        self.veh_label.pack()
        self.veh_label.place(x=65,y=360)
        self.veh_text = Text(self.signup_gui,font=("Ubuntu",16),height = 1.2, width = 30,pady=3,padx=5)
        self.veh_text.pack()
        self.veh_text.place(x=65,y=390)
        ...
        self.submit_Button.pack()
        self.submit_Button.place(x=200,y=590)
        ...
        self.log_Button.pack(side=LEFT)
        self.log_Button.place(x=85,y=630)
        ...
        self.back_Button.place(x=315,y=630)
    ...
    def fetch_SignUp_Value(self):
        ...
        conn = mysql.connector.connect(host="localhost",user="spidy",passwd="123",database="KUBER")
        cur = conn.cursor()
        queryy = "Insert Into Driver (Name,Mob,vehNo,gmail,password) values (%s,%s,%s,%s,%s)"
        val = (name,new_mob,veh,e_mail,pswd)
    ...
    def Send_To_DriveHome(self,ans):
